...
Instead, he focussed on reviving old ideas: de Sitter Space and the
Sciama Principle.  de Sitter Space is a solution to Einstein's general
relativity, a uniformly curved universe.
...
exceed 1.0.  If two maximally rotating black holes merge there is
nowhere for their angular momentum to go but out into the universe.
